...
jQuery(function($) {
	...
	$.fn.nyroModal.settings = {
		...
		closeButton: '<center><a href="#" class="nyroModalClose" id="closeBut" title="Fechar">Fechar</a></center>', // Adding automaticly as the first child of #nyroModalWrapper
